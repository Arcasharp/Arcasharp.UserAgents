...
public static partial class UserAgents
{
    private static readonly string[] TopUserAgents = new string[] {
         ...
         "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) quickarc/1.0.0 Chrome/142.0.7444.235 Electron/39.2.7 Safari/537.36",
    ...
    private const int TopUserAgentsCount = 73;
}