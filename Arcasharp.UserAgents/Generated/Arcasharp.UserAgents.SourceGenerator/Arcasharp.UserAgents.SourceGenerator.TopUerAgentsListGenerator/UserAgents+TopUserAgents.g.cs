...
public static partial class UserAgents
{
    private static readonly string[] TopUserAgents = new string[] {
         ...
         "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) ScalboostBrowser/4.3.5 Chrome/144.0.7559.177 Electron/40.6.0 Safari/537.36",
         ...
         "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) ScalboostBrowser/4.3.4 Chrome/144.0.7559.177 Electron/40.6.0 Safari/537.36",
         ...
         "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) obsidian/1.11.7 Chrome/142.0.7444.265 Electron/39.5.1 Safari/537.36"
    };
    
    private static readonly ReadOnlyCollection<string> TopUserAgentsCollection = new(TopUserAgents);
        
    private const int TopUserAgentsCount = 80;
}