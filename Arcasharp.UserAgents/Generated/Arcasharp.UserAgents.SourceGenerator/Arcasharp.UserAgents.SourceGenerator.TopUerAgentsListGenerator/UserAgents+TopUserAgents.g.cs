...
public static partial class UserAgents
{
    private static readonly string[] TopUserAgents = new string[] {
         ...
         "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) obsidian/1.9.14 Chrome/140.0.7339.240 Electron/38.4.0 Safari/537.36",
    ...
    private const int TopUserAgentsCount = 74;
}